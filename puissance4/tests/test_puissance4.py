...
class TestTrainingMethods(unittest.TestCase):
    def test_prepare_and_train(self):
        is_consistent, _, _ = puissance4.prepare_and_train(
    ...
    def test_prepare_and_train_vs_monte_carlo(self):
        is_consistent_deterministic, _, _ = puissance4.prepare_and_train(
            trainer_choice='MC',
            num_parties_jouees=10,
        ...
        is_consistent_random, _, _ = puissance4.prepare_and_train(
            trainer_choice='MC',
            num_parties_jouees=10,
    ...
    def test_save_then_load_model(self):
        is_consistent_save, _, _ = puissance4.prepare_and_train(
            trainer_choice='Random',
        ...
        is_consistent_load, _, _ = puissance4.prepare_and_train(
            trainer_choice='MC',
            num_parties_jouees=3,
            load_and_save_previously_trained_model=True,
        )
